...
tag: "Neu"
description: "Endpoint, Profil und Bucket prüfen und zunächst mit einem lesenden AWS-CLI-Aufruf testen."
---
...
## Clients, Berechtigungen und Speicherbudget

<AccordionGroup>

<a id="cyberduck-dns-fehler-durch-die-bucket-adressierung" />

<Accordion title="Cyberduck: DNS-Fehler durch die Bucket-Adressierung" id="9SxGH">
...
Prüfen Sie nach der Korrektur zunächst lesend, ob der benötigte Bucket und die erwarteten Objekte erreichbar sind. Ein erfolgreicher Verbindungsaufbau ist noch kein Nachweis eines vorhandenen Backups. Technische Quelle: [Cyberduck: S3-Buckets über Pfade ansprechen](https://docs.cyberduck.io/protocols/s3/#connecting-using-deprecated-path-style-requests)

</Accordion>

<a id="mehrere-buckets-und-das-speicherbudget" />

<Accordion title="Mehrere Buckets und das Speicherbudget" id="yZ5fU">
...
<a id="bucket-erreichbar-aber-datei-kann-nicht-angelegt-werden" />

<Accordion title="Bucket erreichbar, aber Datei kann nicht angelegt werden" id="ZEdBq">
...
<a id="öffentliche-objekte-und-gesperrte-bucket-auflistung" />

<Accordion title="Öffentliche Objekte und gesperrte Bucket-Auflistung" id="g1E4L">
...
Technische Referenz zum Unterschied: [AWS: Einzelnes Objekt lesen](https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetObject.html) und [AWS: Objekte im Bucket auflisten](https://docs.aws.amazon.com/AmazonS3/latest/API/API_ListObjectsV2.html) . Für den EDIS-Dienst bleiben dessen bestätigte Zugriffseinstellungen maßgeblich.
...
- [AWS CLI: Eigene Endpoints verwenden](https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-endpoints.html)
- [AWS CLI: S3-Inhalte auflisten](https://docs.aws.amazon.com/cli/latest/reference/s3/ls.html)
